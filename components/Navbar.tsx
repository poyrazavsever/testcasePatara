  ...
  return (
    <header className="w-full h-16 px-4 flex items-center justify-between bg-black text-white">
      ...
      <div className="flex-1 mx-8 max-w-xl relative">
        ...
        />
        <div className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-gray-400 bg-gray-800 px-2 py-0.5 rounded">
          ⌘ K
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <Button className="cursor-pointer bg-blue-600 text-white hover:bg-blue-500 transition-all duration-200 text-sm px-4 py-2">
          Connect/Sign in
        </Button>
      </div>
    </header>
